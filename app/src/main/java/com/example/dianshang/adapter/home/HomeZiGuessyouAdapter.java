...
public class HomeZiGuessyouAdapter extends RecyclerView.Adapter {
    private ArrayList<HomeBean.DataBean.HotProductListBean> list;
    private Context context;

    public HomeZiGuessyouAdapter(ArrayList<HomeBean.DataBean.HotProductListBean> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_zi_guessyou, parent, false);
