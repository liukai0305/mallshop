package com.example.dianshang.modle;

import android.util.Log;


import com.example.dianshang.common.Constants;
import com.example.dianshang.modle.api.DsApi;
import com.example.dianshang.utils.SystemUtils;
...
public class HttpManager {
    ...
    public DsApi getDsApi(){
        if(dsApi == null){
            dsApi = getRetrofit(Constants.Base_Dianshang).create(DsApi.class);
        }
        return dsApi;
    }
